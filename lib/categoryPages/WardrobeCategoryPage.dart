...
class WardrobeCategoryPage extends StatefulWidget {
  ...
  const WardrobeCategoryPage({ Key? key, required this.title }) : super(key: key);

  @override
  _WardrobeCategoryPageState createState() => _WardrobeCategoryPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    body: Padding(
      ...
      child: GetBuilder(
        ...
        children: controllerList.allproducts.where((element) => element.category == "WARDROBE").map((e) {
          return InkWell(
