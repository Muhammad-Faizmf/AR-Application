...
class DesksCategoryPage extends StatefulWidget {

  final title;

  const DesksCategoryPage({ Key? key, required this.title }) : super(key: key);

  @override
  _DesksCategoryPageState createState() => _DesksCategoryPageState();
}

class _DesksCategoryPageState extends State<DesksCategoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    body: Padding(
      ...
      child: GetBuilder(
        ...
        children: controllerList.allproducts.where((element) => element.category == "DESK").map((e) {
          return InkWell(
