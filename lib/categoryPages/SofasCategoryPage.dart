...
class SofasCategoryPage extends StatefulWidget {
  final title;
  
  const SofasCategoryPage({ Key? key, required this.title }) : super(key: key);

  @override
  _SofasCategoryPageState createState() => _SofasCategoryPageState();
}

class _SofasCategoryPageState extends State<SofasCategoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    body: Padding(
      ...
      child: GetBuilder(
        ...
        children: controllerList.allproducts.where((element) => element.category == "SOFA").map((e) {
          return InkWell(
