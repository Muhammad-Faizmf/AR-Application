...
class _SearchProductState extends State<SearchProduct> {
  ...
  searchFurnitureList(String value) {
    setState(() {
      display_list = controller.allproducts
          .where((element) =>
            ...
            child: Center(
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintStyle: TextStyle(color: Colors.black45, fontSize: 15.0),
                      ...
                      child: InkWell(
                        onTap: () {
                          Get.to(() => ProductDescription(
                                ...
                                index: display_list[index],
                                render_image: display_list[index].render_image,
                              ));
                        },
                        child: ListTile(
                          leading: Container(
                          ...
                          title: Text(display_list[index].name.toString(),
                              style: TextStyle(fontSize: 16.0)),
                          trailing: Text("Rs ${display_list[index].price}",
                              style: TextStyle(
